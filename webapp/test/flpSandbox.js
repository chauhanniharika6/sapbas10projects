					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "All NE Projects",
									"targetURL": "#NEnmallpro-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"NEnmallpro-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=NE.nmallpro",
									"url": sap.ui.require.toUrl("NE/nmallpro")
								}
							}
						}
					}
